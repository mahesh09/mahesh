jQuery.sap.declare("com.ril.ServiceRequest.util.messages");
jQuery.sap.require("sap.ca.ui.message.message");

com.ril.ServiceRequest.util.messages = {};
 ...
 * @public
 */
com.ril.ServiceRequest.util.messages.showErrorMessage = function(oParameter) {
	var oErrorDetails = com.ril.ServiceRequest.util.messages._parseError(oParameter);
...
com.ril.ServiceRequest.util.messages.getErrorContent = function(oParameter) {
	return com.ril.ServiceRequest.util.messages._parseError(oParameter).sMessage;
};

com.ril.ServiceRequest.util.messages._parseError = function(oParameter) {
	var sMessage = "",
		sDetails = "",
		oEvent = null,
		oResponse = null,
